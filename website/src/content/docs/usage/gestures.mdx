...
Gestures work in the terminal area only. The keyboard toolbar, quick actions menu (FAB), and navigation are excluded.

<Aside>
Gestures are disabled on desktop where mouse interactions are preferred. On mobile, use gestures for quick actions or tap the **Quick Actions FAB** (blue ⚡ button) for immediate access to Clear, Cancel, Clear line, and Exit commands.
</Aside>
