...
## Hiện thanh tab phiên (Chỉ desktop)

Bật/tắt hiển thị thanh tab ngang trên desktop để chuyển đổi phiên nhanh chóng. Khi tắt, dùng sidebar để quản lý phiên.

| Tùy chọn | Hành vi                                   | Mặc định |
| -------- | ----------------------------------------- | -------- |
| Bật      | Thanh tab phiên hiển thị trên desktop     | ✓        |
| Tắt      | Ẩn thanh tab, chỉ dùng sidebar            |          |
...
Ứng dụng tự động kiểm tra cập nhật từ GitHub khi bạn mở app. Bạn cũng có thể kiểm tra thủ công:
- Click nút "Check for updates" trong Settings
- Kết quả hiện inline dưới nút (có sẵn, cập nhật, hoặc lỗi)

## Xóa lịch sử lệnh

Nút "Clear Command History" xóa tất cả lệnh đã lưu trong lịch sử. Hành động này không thể hoàn tác.
