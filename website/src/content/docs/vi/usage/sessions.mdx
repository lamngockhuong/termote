...
- **Chuyển**: Click vào phiên trong sidebar bên trái hoặc click tab phiên
- **Sửa**: Double-click tên phiên, hoặc hover và click icon bút chì
- **Xóa**: Hover và click icon X (cần 2+ phiên)
- **Thêm**: Click "+ Add session" ở dưới cùng hoặc click "+" trên thanh tab
...
### Thanh Tab Phiên (Desktop)

Trên desktop, một **thanh tab ngang** giúp chuyển đổi nhanh giữa các phiên:
- **Chuyển**: Click vào tab phiên
- **Thêm**: Click nút "+" ở cuối thanh tab
- **Xóa**: Hover trên tab, click icon X (cần 2+ phiên)
- **Ẩn/Hiện**: Tắt "Show session tabs" trong Settings để ẩn thanh tab
- **Auto-scroll**: Tab hiện tab phiên đang hoạt động tự động cuộn vào vùng nhìn thấy
